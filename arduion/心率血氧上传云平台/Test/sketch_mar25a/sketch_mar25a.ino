...
void MQTT_POST() {
    ...
    Serial.print("JSON data to publish: ");
    Serial.println(jsonBuf);
    bool publishResult = client.publish(Iot_link_MQTT_Topic_Report, jsonBuf);
    if (publishResult) {
...
void loop() {
    ...
    Serial.print(heart);
    Serial.print(", Raw oxygen saturation: ");
    Serial.print(o2);
    ...
    if (irBuffer[0] > 20000 && validO2 && validHeart && heart > 30 && heart < 250 && o2 > 50 && 
        ...
        Serial.print(heart);
        Serial.print(", Valid oxygen saturation:");
        Serial.print(o2);
        Serial.print(", Valid temperature:");
        Serial.print(temperature);
        Serial.print(", Valid humidity:");
        Serial.println(humidity);
